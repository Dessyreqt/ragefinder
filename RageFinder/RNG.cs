namespace RageFinder
{
    public class RNG
    {
        ...
        public static int GetFormNumber(ref int seed1, ref int seed2)
        {
            seed1++;
            if (seed1 == 256)
            {
            ...
            var rand = (GetNum(seed1) + seed2)%256;
            return rand%8;
        }
    }
}
